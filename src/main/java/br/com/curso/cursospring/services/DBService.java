...
import br.com.curso.cursospring.domain.PagamentoComCartao;
...
import br.com.curso.cursospring.repositories.EstadoRepository;
...
import br.com.curso.cursospring.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "caueas2016@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, encoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Silva", "c_aue_2017@hotmail.com", "66759957075", TipoCliente.PESSOAFISICA, encoder.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27364583","94418393"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Ituá Preto", "190", null, "Alvim", "03584050", cli2, c2);
